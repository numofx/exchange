...
export type Deployment = { matching: `0x${string}`; trade: `0x${string}`; withdrawal?: `0x${string}` };

/** Deployed Matching, TradeModule and (when recorded) WithdrawalModule addresses for a chain, or throws if unknown. */
